...
`flash-read1` 是一个基于 Expo + React Native + TypeScript 的读书 App 阅读体验骨架，当前版本已覆盖书架管理、卷页翻书阅读、阅读进度状态维护、本地轻量听书，以及英文页一键翻译入口。
...
- Mock 数据：内置两本已导入本地 PDF 的英文技术书与语音预设，便于研发联调和 UI 骨架扩展
