...
`flash-read1` 是一个基于 Expo + React Native + TypeScript 的读书 App 阅读体验骨架，当前版本已覆盖书架管理、卷页翻书阅读、阅读进度状态维护、本地轻量听书、英文页选中片段翻译，以及目录导读 / AI 导读面板，并支持从远端服务器拉取全文分页内容。

## 当前范围

- 书架页：展示书籍、阅读进度、最近阅读入口
- 阅读页：书籍标题、章节内容、卷页翻书动效、边缘点击翻页、页码信息、听书控制、页内片段翻译
