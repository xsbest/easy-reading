...
`flash-read1` 是一个基于 Expo + React Native + TypeScript 的读书 App 阅读体验骨架，当前版本已覆盖书架管理、卷页翻书阅读、阅读进度状态维护和本地轻量听书。

## 当前范围

- 书架页：展示书籍、阅读进度、最近阅读入口
- 阅读页：书籍标题、章节内容、卷页翻书动效、边缘点击翻页、页码信息、听书控制
- 本地状态：用 Context + `useReducer` 管理书库与阅读会话
- Mock 数据：内置示例书籍与语音预设，便于研发联调和 UI 骨架扩展
